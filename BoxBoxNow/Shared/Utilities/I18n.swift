...
private let translations: [String: [Language: String]] = [
    ...
    "session.maxDriverTimeTitle": [.es: "TIEMPO MÁX\nPILOTO (MIN)", .en: "MAX DRIVER\nTIME (MIN)", .it: "TEMPO MAX\nPILOTA (MIN)", .de: "MAX. FAHRER-\nZEIT (MIN)", .fr: "TEMPS MAX\nPILOTE (MIN)"],
    "session.maxDriverTimeTooltip": [.es: "Tiempo máximo total por piloto (0 = sin restricción)", .en: "Maximum total drive time per driver (0 = no limit)", .it: "Tempo totale massimo per pilota (0 = nessun limite)", .de: "Maximale Gesamtfahrzeit pro Fahrer (0 = unbegrenzt)", .fr: "Temps de conduite total maximum par pilote (0 = aucune limite)"],
