...
private val translations: Map<String, Map<Language, String>> = mapOf(
    ...
    "session.maxDriverTimeTitle" to mapOf(Language.ES to "TIEMPO MÁX\nPILOTO (MIN)", Language.EN to "MAX DRIVER\nTIME (MIN)", Language.IT to "TEMPO MAX\nPILOTA (MIN)", Language.DE to "MAX. FAHRER-\nZEIT (MIN)", Language.FR to "TEMPS MAX\nPILOTE (MIN)"),
    "session.maxDriverTimeTooltip" to mapOf(Language.ES to "Tiempo máximo total por piloto (0 = sin restricción)", Language.EN to "Maximum total drive time per driver (0 = no limit)", Language.IT to "Tempo totale massimo per pilota (0 = nessun limite)", Language.DE to "Maximale Gesamtfahrzeit pro Fahrer (0 = unbegrenzt)", Language.FR to "Temps de conduite total maximum par pilote (0 = aucune limite)"),
