 ...
 * the web. White background, large bold black text for at-a-glance
 * readability on track. Tap anywhere to dismiss; auto-closes after 5 s.
 * Mirrors iOS `DriverMessageOverlay`.
 */
@Composable
fun DriverMessageOverlay(text: String, onDismiss: () -> Unit) {
    LaunchedEffect(text) {
        delay(5_000)
        onDismiss()
    }
