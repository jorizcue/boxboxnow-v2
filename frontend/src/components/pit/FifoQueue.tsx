  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-surface rounded-xl p-8 text-center border border-border">
        <h2 className="text-[11px] text-neutral-200 mb-3 uppercase tracking-wider">Puntuacion Box</h2>
      ...
      <div className="bg-surface rounded-xl p-4 border border-border">
        <h3 className="text-[11px] text-neutral-200 mb-3 uppercase tracking-wider">Cola FIFO Actual</h3>
