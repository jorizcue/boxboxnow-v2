...
const translations: Record<string, Record<Language, string>> = {
  ...
  "status.pitClosed": { es: "PIT CERRADO", en: "PIT CLOSED", it: "PIT CHIUSO", de: "PIT GESCHL.", fr: "STAND FERMÉ" },
  "status.pitOpen": { es: "PIT ABIERTO", en: "PIT OPEN", it: "PIT APERTO", de: "PIT OFFEN", fr: "STAND OUVERT" },
  ...
  "status.pitReason.stint_too_long": { es: "¡Pita ya! Stint máximo superado", en: "Pit now! Stint max exceeded", it: "Box ora! Stint max superato", de: "Sofort Box! Stint-Max überschritten", fr: "Au stand ! Stint max dépassé" },
  ...
  "pit.openIn": { es: "Pit abre en", en: "Pit opens in", it: "Box apre tra", de: "Box öffnet in", fr: "Stand ouvre dans" },

  // === Navbar ===
  "nav.race": { es: "Carrera", en: "Race", it: "Gara", de: "Rennen", fr: "Course" },
  "nav.box": { es: "Box", en: "Box", it: "Box", de: "Box", fr: "Stand" },
  ...
  "race.pit": { es: "Pit", en: "Pit", it: "Pit", de: "Pit", fr: "Stand" },
  "race.stint": { es: "Stint", en: "Stint", it: "Stint", de: "Stint", fr: "Relais" },
  "race.inPit": { es: "En boxes", en: "In pit", it: "Ai box", de: "In der Box", fr: "Au stand" },
  ...
  "metric.kartsNearPit": { es: "Karts cerca de PIT", en: "Karts near PIT", it: "Kart vicini al PIT", de: "Karts nahe PIT", fr: "Karts proches du STAND" },
  ...
  // === Pit / FIFO ===
  "pit.pits": { es: "Pits", en: "Pits", it: "Pit", de: "Pits", fr: "Stands" },
  "pit.currentPit": { es: "Pit en curso", en: "Current pit", it: "Pit in corso", de: "Aktueller Pit", fr: "Stand en cours" },
  "pit.minPitTime": { es: "Tiempo minimo de pit", en: "Min pit time", it: "Tempo minimo di pit", de: "Min Pit-Zeit", fr: "Temps min au stand" },
  "pit.pitCount": { es: "Numero de pits", en: "Pit count", it: "Numero di pit", de: "Anzahl Pits", fr: "Nombre de stands" },
  "pit.stintLaps": { es: "Vueltas de stint", en: "Stint laps", it: "Giri stint", de: "Stint-Runden", fr: "Tours de relais" },
  "pit.minPitCount": { es: "Numero minimo de pits", en: "Min pit count", it: "Numero minimo di pit", de: "Min Pit-Anzahl", fr: "Nombre min de stands" },
  ...
  "pit.history": { es: "Historial de entradas en box", en: "Pit entry history", it: "Storico ingressi ai box", de: "Boxen-Einfahrts-Historie", fr: "Historique des entrées au stand" },
  ...
  "adjusted.missingPits": { es: "Pits pend.", en: "Missing pits", it: "Pit manc.", de: "Fehl. Pits", fr: "Stands manq." },
  ...
  "adjusted.explanation": { es: "Pits oblig.: {minPits} · Ref. pit: {pitRef}s · Carrera: {raceTime}", en: "Mandatory pits: {minPits} · Pit ref: {pitRef}s · Race: {raceTime}", it: "Pit oblig.: {minPits} · Rif. pit: {pitRef}s · Gara: {raceTime}", de: "Pflicht-Pits: {minPits} · Pit Ref: {pitRef}s · Rennen: {raceTime}", fr: "Stands oblig. : {minPits} · Réf. stand : {pitRef}s · Course : {raceTime}" },
  "adjusted.pendingPits": { es: "Pendient.", en: "Pending", it: "In sospeso", de: "Ausstehend", fr: "En attente" },
  "adjusted.inPit": { es: "en box", en: "in pit", it: "in pit", de: "in Box", fr: "au stand" },
  ...
  "config.sectionPitStops": { es: "Pit Stops", en: "Pit Stops", it: "Pit Stop", de: "Boxenstopps", fr: "Arrêts au stand" },
  ...
  "config.minPits": { es: "Pits minimos", en: "Min pits", it: "Pit minimi", de: "Min Pits", fr: "Stands min" },
  "config.pitTime": { es: "Tiempo pit (s)", en: "Pit time (s)", it: "Tempo pit (s)", de: "Pit-Zeit (s)", fr: "Temps stand (s)" },
  ...
  "config.boxLines": { es: "Lineas box", en: "Box lines", it: "Linee box", de: "Box-Reihen", fr: "Lignes stand" },
  "config.boxKarts": { es: "Karts en box", en: "Karts in box", it: "Kart nel box", de: "Karts in Box", fr: "Karts au stand" },
  "config.pitClosedStart": { es: "Pit cerrado inicio (min)", en: "Pit closed start (min)", it: "Pit chiuso inizio (min)", de: "Pit geschlossen Start (Min)", fr: "Stand fermé début (min)" },
  "config.pitClosedEnd": { es: "Pit cerrado final (min)", en: "Pit closed end (min)", it: "Pit chiuso fine (min)", de: "Pit geschlossen Ende (Min)", fr: "Stand fermé fin (min)" },
  ...
  "admin.pitTime": { es: "Pit Time (s)", en: "Pit Time (s)", it: "Pit Time (s)", de: "Pit-Zeit (s)", fr: "Temps stand (s)" },
  ...
  "driver.boxScore": { es: "Punt. Box", en: "Box Score", it: "Punt. Box", de: "Box Punkt.", fr: "Score Stand" },
  ...
  "driver.pitWindow": { es: "Ventana Pit", en: "Pit Window", it: "Finestra Pit", de: "Pit Fenster", fr: "Fenêtre Stand" },

  // BOX call button
  "box.callBox": { es: "Llamar a BOX", en: "Call BOX", it: "Chiama BOX", de: "BOX rufen", fr: "Appeler au STAND" },
