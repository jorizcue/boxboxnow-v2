...
const translations: Record<string, Record<Language, string>> = {
  ...
  "pit.time": { es: "Hora", en: "Time", it: "Ora", de: "Zeit" },
  ...
  "adjusted.explanation": { es: "Pits oblig.: {minPits} · Ref. pit: {pitRef}s · Carrera: {raceTime}", en: "Mandatory pits: {minPits} · Pit ref: {pitRef}s · Race: {raceTime}", it: "Pit oblig.: {minPits} · Rif. pit: {pitRef}s · Gara: {raceTime}", de: "Pflicht-Pits: {minPits} · Pit Ref: {pitRef}s · Rennen: {raceTime}" },
  "adjusted.pendingPits": { es: "Pendient.", en: "Pending", it: "In sospeso", de: "Ausstehend" },
  "adjusted.inPit": { es: "en box", en: "in pit", it: "in pit", de: "in Box" },
  ...
  "replay.play": { es: "Reproducir", en: "Play", it: "Riproduci", de: "Abspielen" },
  "replay.download": { es: "Descargar", en: "Download", it: "Scarica", de: "Herunterladen" },
  ...
  "driver.openWindow": { es: "Abrir vista en ventana", en: "Open view in window", it: "Apri vista in finestra", de: "Ansicht in Fenster öffnen" },
  "driver.bestStintLap": { es: "Mejor vuelta stint", en: "Best stint lap", it: "Miglior giro stint", de: "Beste Stint-Runde" },
  ...
  "driver.gpsConnect": { es: "Conectar RaceBox", en: "Connect RaceBox", it: "Connetti RaceBox", de: "RaceBox verbinden" },
  "driver.gpsDisconnect": { es: "Desconectar", en: "Disconnect", it: "Disconnetti", de: "Trennen" },
  "driver.gpsSat": { es: "sat", en: "sat", it: "sat", de: "Sat" },
  "driver.setFinishP1": { es: "Punto 1 meta", en: "Finish P1", it: "Punto 1 traguardo", de: "Ziel P1" },
  "driver.setFinishP2": { es: "Punto 2 meta", en: "Finish P2", it: "Punto 2 traguardo", de: "Ziel P2" },
  "driver.finishSet": { es: "Meta configurada", en: "Finish line set", it: "Traguardo configurato", de: "Ziellinie gesetzt" },
  "driver.noFinishLine": { es: "Sin meta", en: "No finish line", it: "Senza traguardo", de: "Keine Ziellinie" },
  "driver.maxSpeed": { es: "Max", en: "Max", it: "Max", de: "Max" },
  "driver.lateral": { es: "Lat", en: "Lat", it: "Lat", de: "Lat" },
  "driver.braking": { es: "Fren", en: "Brk", it: "Fren", de: "Brems" },
